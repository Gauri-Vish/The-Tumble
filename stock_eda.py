...
if layout=='Comparision':
        ...
        with col2:
                ...
                if selected_stock[1]=='XOM':
                    ...
                    st.write('US Oil Index represents the most liquid and large capitalised stocks from the oil and gas sector which trade on the New York Stock Exchange (NSE). It provides investors and market intermediaries a benchmark that captures the capital market performance of US OIl and gas sector.')                
